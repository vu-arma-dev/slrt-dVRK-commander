...
Hybrid_admitance_set_goal_pose(PSM_CMD,[0;0;0],[1;0;0;0],'Motion Mode','relative');

%%
% % Test a movement!
Hybrid_admittance_config(PSM_CMD,'sine_go',1);
Hybrid_admitance_set_goal_pose(PSM_CMD,...
    [-15;-15;0],[1;0;0;0],'Motion Mode','relative');
